  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () => SubCategoryScreen(
            categoryId: Get.arguments[0], categoryName: Get.arguments[1])),
    ...
    GetPage(
        name: watchPartyHistoryScreen,
        page: () => const WatchPartyHistoryScreen()),
    ...
    GetPage(
        name: tournamentListScreen, page: () => const TournamentListScreen()),
    GetPage(
