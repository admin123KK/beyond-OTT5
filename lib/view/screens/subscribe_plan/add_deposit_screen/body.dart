...
class _BodyState extends State<Body> {
  ...
  void initState() {
    ...
    Get.find<AddNewDepositController>().beforeInitLoadData(widget.price);
  }
                      ...
                      children: [
                        ...
                        Center(
                          child: Text.rich(
                            TextSpan(
                              text:
                                  "${Get.previousRoute == RouteHelper.movieDetailsScreen ? MyStrings.youAreRequestedForRent.tr : MyStrings.youAreRequestedForPlan.tr}\n",
                        ...
                        // Pay Now Button - Uses correct loading state
