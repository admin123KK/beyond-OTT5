...
class WatchPartyVideoPlayerWidget extends StatefulWidget {
  ...
  @override
  State<WatchPartyVideoPlayerWidget> createState() =>
      _WatchPartyVideoPlayerWidgetState();
}

class _WatchPartyVideoPlayerWidgetState
    extends State<WatchPartyVideoPlayerWidget> {
  @override
  void initState() {
    super.initState();
  }
        ...
        children: [
          ...
          if (controller.isCurrentUserHost) ...[
            !controller.videoPlayerController.value.isPlaying &&
                    controller.isCurrentUserHost
                ? Positioned.fill(
                    child: GestureDetector(
                      onTap: () {
                        if (controller.isCurrentUserHost) {
                          controller.playPauseVideo(controller
                                  .roomModel.data?.partyRoom?.id
                                  .toString() ??
                              '-1');
                        }
                      },
