...
class _WishlistWidgetState extends State<WishlistWidget> {
  ...
  void initState() {
    ...
    WishListController controller =
        Get.put(WishListController(repo: Get.find()));
    super.initState();
                          ...
                          GestureDetector(
                            onTap: () {
                              int itemId = int.tryParse(
                                      controller.wishlist[index].itemId ??
                                          '-1') ??
                                  -1;
                              int episodeId = int.parse(
                                  controller.wishlist[index].episodeId ?? '-1');
                              if (itemId != -1) {
                                Get.toNamed(RouteHelper.movieDetailsScreen,
                                    arguments: [itemId, episodeId]);
                              }
                            },
                            child: Padding(
                              padding:
                              ...
                              child: Column(
                                children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CustomNetworkImage(
                                            imageUrl:
                                                '${UrlContainer.baseUrl}${controller.portraitImagePath}${controller.wishlist[index].item?.image?.portrait}',
                                            height: 150,
                                            width: 120,
                                          ),
                                        ),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration:
                                                        const BoxDecoration(
                                                            ...
                                                            color: MyColor
                                                                .textFieldColor),
                                                    // child: controller.removeLoading && index == controller.selectedIndex
                                            ...
                                            Text(
                                              (controller.wishlist[index].item
                                                          ?.description ??
                                                      '')
                                                  .tr,
                                  ...
                                  Divider(
                                    color: controller.wishlist.length - 1 ==
                                                index &&
                                            !controller.hasNext()
                                        ? Colors.transparent
                                  ...
                                  SizedBox(
                                    height: controller.wishlist.length - 1 ==
                                                index &&
                                            !controller.hasNext()
                                        ? 0
                                        : 10,
